...
MINES_MULTIPLIERS = {
    1: [1.03, 1.15, 1.30, 1.50, 1.80, 2.15, 2.90, 4.60],
    2: [1.10, 1.38, 1.75, 2.25, 3.10, 4.50, 7.50],
    3: [1.25, 1.75, 2.55, 3.90, 6.40, 10.80],  # User's exact example
    4: [1.42, 2.30, 3.90, 7.10, 14.50],
    5: [1.70, 3.30, 7.10, 18.00],
    6: [2.10, 5.30, 16.50],
    7: [2.85, 10.50],
    8: [6.90]
}
